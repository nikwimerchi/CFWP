        ...
        <div className="col-span-2 flex gap-4 flex-col">
          <div className="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className="flex items-start mb-1">
              <Link
                className="text-purple-700 underline cursor-pointer flex items-center justify-center gap-1"
                to={'/chat/' + kid.child?._id}
                title="Chatt with AI"
              >
                <BsFillChatSquareQuoteFill /> <span>Chatt with our AI</span>
              </Link>
            </div>
            <HeathData
